...
class MeetingIntelligence(BaseModel):
    ...
    full_summary: str = Field(description="A thorough paragraph-level summary of the meeting")
    executive_summary: str = Field(description="2-3 sentence high-level summary for leadership")
